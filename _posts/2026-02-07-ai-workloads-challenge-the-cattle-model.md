...
AI infrastructure punishes mental models applied from inertia. Generic
abstractions that worked for backend services are too limited, and
treating six-figure hardware as disposable, undifferentiated cattle
seems unacceptable.
...
make effective and efficient use of expensive resources. Distributed
application frameworks like [Ray](https://www.ray.io/) can build on top,
provide users with higher level abstractions tailored for AI workloads
(e.g. the [kube-ray
