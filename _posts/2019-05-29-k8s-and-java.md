...
excerpt: "Running JVM apps in Kubernetes forces you to think about capacity planning differently. Here is how to size pods correctly and avoid the OOM Killer."
